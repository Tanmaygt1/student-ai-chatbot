...
const TOPIC_KEYWORDS = {
  ...
  facilities:   ['library', 'canteen', 'sports', 'gym', 'wifi', 'transport', 'bus', 'facility', 'lab', 'infrastructure', 'campus', 'clubs', 'fest', 'utkarsha', 'activities', 'extracurricular'],
  ...
  faq:          ['management quota', 'donation', 'capitation', 'vit vellore', 'same as vit', 'dress code', 'anti ragging', 'ragging', 'nearest station', 'how to reach', 'is vit autonomous', 'total seats']
};
