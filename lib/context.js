...
const TOPIC_KEYWORDS = {
  hostel:       ['hostel', 'accommodation', 'stay', 'dormitory', 'room', 'mess', 'pg', 'paying guest', 'hostel fee', 'hostel cost'],
  facilities:   ['library', 'canteen', 'sports', 'gym', 'wifi', 'transport', 'bus', 'facility', 'facilities', 'lab', 'infrastructure', 'campus facility', 'campus facilities', 'clubs', 'fest', 'utkarsha', 'activities', 'extracurricular'],
  fees:         ['fee', 'fees', 'cost', 'tuition', 'charges', 'price', 'money', 'pay', 'expensive', 'how much'],
  admissions:   ['admission', 'apply', 'application', 'eligibility', 'cap', 'cet', 'jee', 'document', 'merit', 'intake'],
  placements:   ['placement', 'job', 'salary', 'package', 'lpa', 'recruit', 'company', 'campus placement', 'tpo', 'hiring'],
  ...
  contact:      ['contact', 'address', 'phone', 'email', 'where is', 'location', 'office'],
  rankings:     ['rank', 'ranking', 'nirf', 'naac', 'accreditation', 'rating', 'recognition', 'autonomous', 'affiliated', 'nba', 'aicte'],
  research:     ['research', 'project', 'publication', 'paper', 'internship'],
  ...
  faq:          ['management quota', 'donation', 'capitation', 'vit vellore', 'same as vit', 'dress code', 'anti ragging', 'ragging', 'nearest station', 'is vit autonomous', 'total seats']
};
